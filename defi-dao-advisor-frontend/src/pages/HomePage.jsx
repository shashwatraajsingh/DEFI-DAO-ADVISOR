...
const HomePage = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      color: 'from-Web3-500 to-emerald-500'
    },
    {
    ...
    <div className="bg-gray-900">
      ...
      <div className="relative overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-gradient-to-br from-Web3-900/20 via-gray-900 to-primary-900/20"></div>
          <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-96 h-96 bg-Web3-500/10 rounded-full blur-3xl"></div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center animate-fade-in">
            <div className="mb-8">
              <span className="inline-flex items-center px-4 py-2 rounded-full text-sm font-medium bg-Web3-900/50 text-Web3-300 border border-Web3-800">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight">
              Mass adoption of{' '}
              <span className="bg-gradient-to-r from-Web3-400 via-Web3-300 to-emerald-400 bg-clip-text text-transparent">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link
                to="/create"
                className="inline-flex items-center px-8 py-4 border border-transparent text-lg font-medium rounded-xl text-gray-900 bg-Web3-400 hover:bg-Web3-300 transform hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-Web3-500/25"
              >
                Create Proposal
              ...
              {isConnected && (
                <Link
                  to="/dashboard"
                  className="inline-flex items-center px-8 py-4 border border-Web3-600 text-lg font-medium rounded-xl text-Web3-400 hover:bg-Web3-900/50 hover:border-Web3-500 transition-all duration-200"
                >
                  Dashboard
                  <ArrowRightIcon className="ml-2 h-5 w-5" />
                </Link>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-white mb-4 group-hover:text-Web3-300 transition-colors">
                  {feature.title}
                </h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            {stats.map((stat, index) => (
              ...
              >
                <div className="text-4xl lg:text-5xl font-bold text-Web3-400 mb-2">
                  {stat.label}
                </div>
      ...
      {/* CTA Section */}
      <div className="py-20 bg-gradient-to-r from-Web3-600 via-Web3-500 to-emerald-500">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl lg:text-4xl font-bold text-white mb-6">
            Ready to shape the future of governance?
          </h2>
          <p className="text-xl text-Web3-100 mb-10 leading-relaxed">
          ...
          <Link
            to="/create"
            className="inline-flex items-center px-10 py-5 border border-transparent text-xl font-medium rounded-xl text-Web3-900 bg-white hover:bg-gray-100 transform hover:scale-105 transition-all duration-200 shadow-2xl"
          >
            Get Started Now
